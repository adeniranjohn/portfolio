    ...
    return (
        <section className="projects">
            ...
            <Card>
                ...
                <Typography variant="span" align="left">   <Typography variant="span" color="secondary" align="left">Tech stack: </Typography>Amazon Web Services (RDS), Heroku, Firebase, PostgreSQL, Angular, NodeJS, Express and Git</Typography>
            </Card>
            ...
            <Card>
                ...
                <Typography variant="p" align="left" > <Typography variant="span" color="secondary" align="left">Tech stack: </Typography>Firebase, Angular, NodeJS, Express and Git</Typography>
            ...
            <Card>
                ...
                <Box style={{ padding: '1em', marginBottom: '0.5em' }}>
                    ...
                    <Typography variant="p" align="left" > <Typography variant="span" color="secondary" align="left">Knowledge base: </Typography> Azure Cloud Computing</Typography>
                </Box>
                ...
                <Box style={{ padding: '1em', marginBottom: '0.5em' }}>
                    ...
                    <Typography variant="p" align="left"><Typography variant="span" color="secondary" align="left">Knowledge base: </Typography> Javascript & React Framework</Typography>
